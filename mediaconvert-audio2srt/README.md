...
![](AWS-ScriptHub/mediaconvert-audio2srt/images/iamge1.png)
...
![](AWS-ScriptHub/mediaconvert-audio2srt/images/iamge2.png)

点击进入路径中，其中结果文件的路径名称会和原视频所在路径名称一一对应（包括子目录中的文件）

![](AWS-ScriptHub/mediaconvert-audio2srt/images/iamge3.png)

![](AWS-ScriptHub/mediaconvert-audio2srt/images/iamge4.png)
...
![](AWS-ScriptHub/mediaconvert-audio2srt/images/iamge5.png)
